...
it("handles flex direction prop", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "flex-direction: ${someVar};`} />;"
  )
})
...
it("width expression variable", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "width: ${variable};`} />;"
  )
})
...
it("width expression variable, then height", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "width: ${variable};height: 20px;`} />;"
  )
})
...
it("handles basic (copied) layout props", () => {
  ...
  expect(code).toBe(
    "<div css={`" +
      defaultFlexCss +
      "width: 20px;height: 20px;padding: 20px;margin: 20px;z-index: 1;flex-shrink: 1;`} />;"
  )
})
...
it("handles partial expression props", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "padding-top: ${someVar}px;`} />;"
  )
})
...
it("handles partial interpolated expression props", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "padding-top: ${20 + 'px'};`} />;"
  )
})
...
it("handles center variable prop", () => {
  ...
  expect(code).toBe(
    "<div css={`" +
      defaultFlexCss +
      '${someVar === true ? "align-items: center;justify-content: center;" : ""}`} />;'
  )
})
...
it("handles inline prop", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "display: inline-flex;`} />;"
  )
})
...
it("handles fit prop", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "height: 100%;width: 100%;`} />;"
  )
})
...
it("handles grow var prop", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "flex-grow: ${someVar};`} />;"
  )
})
...
it("css prop with height prop", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "height: 20px;width: 20px;`} />;"
  )
})
...
it("css prop with dynamic height prop", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "height: ${someVar};width: 20px;`} />;"
  )
})
...
it("css prop with dynamic width", () => {
  ...
  expect(code).toBe(
    "<div css={`" + defaultFlexCss + "width: ${someVar}px;`} />;"
  )
})
...
it("css prop with multiple dynamic attributes", () => {
  ...
  expect(code).toBe(
    "<div css={`" +
      defaultFlexCss +
      "width: ${someVar}px;height: ${someHeight}px;`} />;"
  )
})
...
it("css prop with multiple dynamic fields and props", () => {
  ...
  expect(code).toBe(
    "<div css={`" +
      defaultFlexCss +
      "height: ${someHeight};margin: ${someMargin};width: ${someVar}px;padding: ${somePadding}px;`} />;"
  )
})
...
it("converts inlineStyle to style", () => {
  ...
  expect(code).toBe(
    "<div style={{width: 20}} css={`" + defaultFlexCss + "height: 20px;`}  />;"
  )
})
